function buildCodeBlocks() {
    return (
        "<div class='codeBlocks clearfix'><pre class='html'><code>" +
        getHtml() +
        "</code></pre><pre class='javascript'><code>" +
        cleanJson($("head script").last().text()) +
        "</code></pre><pre class='css'><code>" +
...
function getHtml() {
    var t, i, e, s;
    return (
        (t = $("<div />").append($("div#content").contents().not("h2, p").clone())),
        (i = t.find("ul")),
        (e = i.find("li")),
...
!(function (t, i) {
    ...
    return (function (t) {
                ...
                return (
                    (n.init = function () {
                        var i = this,
                            e = this.config;
                        t(this.element)
                            .find(e.parentTrigger + "." + e.activeClass)
                            .has(e.subMenu)
                            .children(e.subMenu)
                            .addClass(e.collapseClass + " " + e.collapseInClass),
                            t(this.element)
                                .find(e.parentTrigger)
                                .not("." + e.activeClass)
                                .has(e.subMenu)
                                .children(e.subMenu)
                                .addClass(e.collapseClass),
                            t(this.element)
                                .find(e.parentTrigger)
                                .has(e.subMenu)
                                .children(e.triggerElement)
                                .on(r.CLICK_DATA_API, function (s) {
                                    var n = t(this),
                                    ...
                                    e.preventDefault && s.preventDefault(),
                                        ...
                                        (a.hasClass(e.activeClass)
                                            ? (n.attr("aria-expanded", !1), i.hide(o))
                                            : (i.show(o),
                    ...
                    (n.show = function (i) {
                        ...
                        if (
                            !this.transitioning &&
                            !t(i).hasClass(this.config.collapsingClass)
                        ) {
                            var n = t(i),
                                a = t.Event(r.SHOW);
                    ...
                    (n.hide = function (i) {
                        ...
                        if (
                            !this.transitioning &&
                            t(i).hasClass(this.config.collapseInClass)
                        ) {
                            var n = t(i),
                                a = t.Event(r.HIDE);
                            if ((n.trigger(a), !a.isDefaultPrevented())) {
                    ...
                    (i.jQueryInterface = function (s) {
                        return this.each(function () {
                            ...
                            if (
                                (!r && /dispose/.test(s) && this.dispose(),
                                    r || ((r = new i(this, o)), n.data("metisMenu", r)),
                                    "string" == typeof s)
                            ) {
                                if (void 0 === r[s])
        ...
        return (
            (t.fn[i] = o.jQueryInterface),
            (t.fn[i].Constructor = o),
            (t.fn[i].noConflict = function () {
                return (t.fn[i] = n), o.jQueryInterface;
            }),
            o
        );
    })(t);
            ...
            slimScroll: function (e) {
                ...
                return (
                    this.each(function () {
                        ...
                        function a(t, i, e) {
                            ...
                            if (
                                (i &&
                                    ((s =
                                        parseInt(S.css("top")) +
                                        ((t * parseInt(n.wheelStep)) / 100) * S.outerHeight()),
                                        (s = Math.min(Math.max(s, 0), a)),
                                        (s = t > 0 ? Math.ceil(s) : Math.floor(s)),
                                        S.css({ top: s + "px" })),
                                    (f =
                                        parseInt(S.css("top")) / (b.outerHeight() - S.outerHeight())),
                                    (s = f * (b[0].scrollHeight - b.outerHeight())),
                                    e)
                            ) {
                                s = t;
                                var r = (s / b[0].scrollHeight) * b.outerHeight();
                                (r = Math.min(Math.max(r, 0), a)), S.css({ top: r + "px" });
                            }
                            b.scrollTop(s), b.trigger("slimscrolling", ~~s), o(), h();
                        }
                        function r() {
                            (p = Math.max(
                        ...
                        function o() {
                            if ((r(), clearTimeout(u), f == ~~f)) {
                                if (((w = n.allowPageScroll), m != f)) {
                                    var t = 0 == ~~f ? "top" : "bottom";
                                    b.trigger("slimscroll", t);
                                }
                            } else w = !1;
                            if (((m = f), p >= b.outerHeight())) return void (w = !0);
                        ...
                        if (b.parent().hasClass(n.wrapperClass)) {
                            ...
                            if (
                                ...
                                if ("height" in e && "auto" == e.height) {
                                    ...
                                    var P = e.height;
                                    b.parent().css("height", P), b.css("height", P);
                                }
                                if ("scrollTo" in e) y = parseInt(n.scrollTo);
                                else if ("scrollBy" in e) y += parseInt(n.scrollBy);
                                else if ("destroy" in e)
                                    return S.remove(), k.remove(), void b.unwrap();
                                a(y, !1, !0);
                            }
                            ...
                            k.css(x),
                                ...
                                b.bind("touchmove", function (t) {
                                    if (
                                        (w || t.originalEvent.preventDefault(),
                                            t.originalEvent.touches.length)
                                    ) {
                                        a(
                                            (g - t.originalEvent.touches[0].pageY) /
                                ...
                                r(),
                                "bottom" === n.start
                                    ? (S.css({ top: b.outerHeight() - S.outerHeight() }),
                                        a(0, !0))
                                    : "top" !== n.start &&
                                    (a(i(n.start).position().top, null, !0),
    ...
    (function (t, i, e, s) {
            ...
            return (
                ...
                this.each(function () {
                    var s = t(this),
                        r = s.data("_peity");
                    r
                        ? (i && (r.type = i), t.extend(r.opts, e))
                        : ((r = new a(
                            s,
                            i,
                            t.extend({}, n.defaults[i], s.data("peity"), e)
                        )),
                            s
                                .change(function () {
                                    r.draw();
        ...
        (r.draw = function () {
            var t = this.opts;
            n.graphers[this.type].call(this, t), t.after && t.after.call(this, t);
        }),
            (r.fill = function () {
            ...
            (r.prepare = function (t, i) {
                return (
                    this.$svg ||
                    this.$el.hide().after((this.$svg = o("svg", { class: "peity" }))),
            ...
            n.register(
                ...
                function (i) {
                    ...
                    for (var h = 0, l = n.length, c = 0; h < l; h++) c += n[h];
                    c || ((l = 2), (c = 1), (n = [0, 1]));
                    var d = 2 * i.radius,
                    ...
                    for (h = 0; h < l; h++) {
                        ...
                        if (0 != k) {
                            if (1 == k)
                                ...
                                } else P = o("circle", { cx: f, cy: m, "data-value": j, r: v });
                            else {
                                var T = C + j,
                                    I = ["M"].concat(
                                        y(C, v),
                                ...
                                _
                                    ...
                                    : I.push(f, m),
                                    (C += j),
                                    (P = o("path", { d: I.join(" "), "data-value": j }));
                            }
                            P.attr("fill", b.call(this, j, h, n)), u.append(P);
                        }
                    }
                }
            ),
            ...
            n.register(
                ...
                function (t) {
                    ...
                    for (
                        var s = e.max.apply(e, void 0 == t.max ? i : i.concat(t.max)),
                        n = e.min.apply(e, void 0 == t.min ? i : i.concat(t.min)),
                    ...
                    p.push(h, g),
                        t.fill &&
                        a.append(o("polygon", { fill: t.fill, points: p.join(" ") })),
                        r &&
                        a.append(
                            o("polyline", {
                                fill: "none",
            ...
            n.register(
                ...
                function (t) {
                    for (
                        var i = this.values(),
                        s = e.max.apply(e, void 0 == t.max ? i : i.concat(t.max)),
                        n = e.min.apply(e, void 0 == t.min ? i : i.concat(t.min)),
                        a = this.prepare(t.width, t.height),
                        r = a.width(),
                        h = a.height(),
    ...
    (function (t, i, e, s) {
        ...
        (n.prototype = {
            ...
            getCSSAnimationSupport: function () {
                ...
                if ((s.style.animationName && (t = !0), !1 === t))
            ...
            writeNav: function () {
                ...
                for (
                    ...
                    t += this.writeBtn("first") + this.writeBtn("previous");
                    i <= this._numPages;
                    i++
                ) {
                    switch (
                ...
                return (
                    (t += this.writeBtn("next") + this.writeBtn("last") + "</div>"),
                    (t += "</ul></nav>")
                );
            },
            writeBtn: function (i) {
                return !1 === this.options[i] || t(this["_" + i]).length
                    ? ""
                    : "<li class=''><a class='jp-" +
                    i +
                    "'>" +
            ...
            cacheNavElements: function (i, e) {
                (this._nav[e] = {}),
                    ...
                    (this._nav[e].first = this._first.length
                        ? this._first
                        : this._nav[e].holder.find("a.jp-first")),
                    (this._nav[e].previous = this._previous.length
                        ? this._previous
                        : this._nav[e].holder.find("a.jp-previous")),
                    (this._nav[e].next = this._next.length
                        ? this._next
                        : this._nav[e].holder.find("a.jp-next")),
                    (this._nav[e].last = this._last.length
                        ? this._last
                        : this._nav[e].holder.find("a.jp-last")),
                    (this._nav[e].fstBreak = this._nav[e].holder.find("span:first")),
                    (this._nav[e].lstBreak = this._nav[e].holder.find("span:last")),
                    (this._nav[e].pages = this._nav[e].holder
                        .find("a")
                        .not(".jp-first, .jp-previous, .jp-next, .jp-last")),
                    (this._nav[e].permPages = this._nav[e].pages
                        .slice(0, this.options.startRange)
                        .add(
                            this._nav[e].pages.slice(
            ...
            bindNavHandlers: function (i) {
                ...
                e.holder.bind(
                    ...
                    this.bind(function (i) {
                        ...
                        this.validNewPage(s) && ((this._clicked = !0), this.paginate(s)),
                            i.preventDefault();
                    }, this)
                ),
                    this._first.length &&
                    ...
                    this._previous.bind(
                        ...
                        this.bind(function () {
                            ...
                            this.validNewPage(t) &&
                                ((this._clicked = !0), this.paginate(t));
                        }, this)
                    ),
                    this._next.length &&
                    this._next.bind(
            ...
            bindNavScrollBrowse: function () {
                this._container.bind(
                    ...
                    this.bind(function (t) {
                        var i =
                            (t.originalEvent.wheelDelta || -t.originalEvent.detail) > 0
                    ...
                    : i.is(t.pages)
                        ...
                        : i.is(t.first)
                            ...
                            : i.is(t.last)
                                ? this._numPages
                                : i.is(t.previous)
                                    ? t.pages.index(t.currentPage)
                                    : i.is(t.next)
                                        ? t.pages.index(t.currentPage) + 2
                                        : void 0;
            },
            ...
            getItemRange: function (t) {
                var i = {};
                return (
                    (i.start = (t - 1) * this.options.perPage),
            ...
            getDirectedItems: function (i) {
                ...
                switch (this.options.direction) {
                    ...
                    case "auto":
                        e =
                            i >= this._currentPageNum
                                ? this._itemsShowing
                                : t(this._itemsShowing.get().reverse());
                        break;
                    default:
            ...
            updateBreaks: function (t, i) {
                i.start > this.options.startRange ||
                    (0 === this.options.startRange && i.start > 0)
                    ? t.fstBreak.removeClass("jp-hidden")
                    : t.fstBreak.addClass("jp-hidden"),
                    i.end < this._numPages - this.options.endRange
                        ? t.lstBreak.removeClass("jp-hidden")
                        : t.lstBreak.addClass("jp-hidden");
            },
            callback: function (t, i, e) {
                var s = { current: t, interval: e, count: this._numPages },
                    n = {
                        showing: this._itemsShowing,
                        oncoming: this._items.slice(
                            i.start + this.options.perPage,
                ...
                return "object" === e
                    ...
                    : "string" === e && "destroy" === i
                        ? (r.destroy(),
                            ...
                            this)
                        : "number" === e && i % 1 == 0
                            ? (r.validNewPage(i) && r.paginate(i), this)
                            : this;
            });
    ...
    $(function () {
        var t = 0,
            ...
            e = function (e) {
                (t = 0), (i = !e);
                var s = e ? "block" : "none";
                $("#search-content").val(""), $(".search-tool").css("display", s);
            },
            s = function (i) {
                var e = i - t;
                return (t = i), e < 500;
